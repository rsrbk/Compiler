//
//  ConstantsTableViewExtension.swift
//  Translators
//
...
class ConstantsTableViewExtension: NSObject {
    var rows: [Int] = []
...
extension ConstantsTableViewExtension: NSTableViewDelegate, NSTableViewDataSource {
